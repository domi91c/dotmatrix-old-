...
autocmd BufRead,BufNewFile *.py nnoremap <buffer><silent><C-]> :YcmCompleter GoTo<CR>
autocmd BufRead,BufNewFile *.cpp nnoremap <buffer><silent><C-]> :YcmCompleter GoTo<CR>
autocmd BufRead,BufNewFile *.c nnoremap <buffer><silent><C-]> :YcmCompleter GoTo<CR>
autocmd BufRead,BufNewFile *.h nnoremap <buffer><silent><C-]> :YcmCompleter GoTo<CR>
...
autocmd BufRead,BufNewFile *.h nnoremap <buffer><silent><Leader>z :w<CR> :!clear; gcc %; ./a.out %<cr>
